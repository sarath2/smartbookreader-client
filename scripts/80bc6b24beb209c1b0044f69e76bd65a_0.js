...
window.Readium = {
	...
	Init: function() {
		...
		window._fp_view_gdrive = new Readium.Views.FilePickerViewGdrive({collection: window._library});
...
Readium.Views.FilePickerViewGdrive = Backbone.View.extend({
	el:"#add-book-modal-gDrive",
	...
	handleUrl: function(evt) {
		///Applications/MAMP/htdocs/fl/chrome_ext/epub_samples/Java for Absolute Beginners.epub
		var that = this;
		var input = document.getElementById('book-url');
		//if(input.value === null || input.value.length < 1) {
		//	alert("invalid url, cannot process");
		...
		//else {
			...
			// TODO check src filename
		console.log('00');
			var url = 'https://doc-10-24-docs.googleusercontent.com/docs/securesc/9pt0tng3jhaa8ibip77ke4ur09kr45ld/qupp09859urajpnbd1u92tokk18d444n/1417521600000/13058876669334088843/15253850492875811781/0B8bA8-WhnfViRUlNLVdnNTRrUVU?e=download&gd=true';
			var accessToken = 'ya29.0AD9EcQiYTpOW9BggiEBGvklzXBwGdzwCnBMHI-RdH8YCeZKALh5LA6ZBXNLsyWNjFsSJiHDnudkgw';
			...
			//var extractor = new Readium.Models.ZipBookExtractor({file: xhr.responseText, src_filename: 'aaa.epub'});
			var extractor = new Readium.Models.ZipBookExtractor({file:file, src_filename: 'aaa.epub'});
			that.beginExtraction(extractor);
				console.log('end');
			};
...
//			xhr.send();
//			url='/Applications/MAMP/htdocs/fl/chrome_ext/epub_samples/Java for Absolute Beginners.epub';
//			var extractor = new Readium.Models.ZipBookExtractor({file: url, src_filename: "aaa.epub"});
//			that.beginExtraction(extractor);
