mainApp.controller('DashboardCtrl', function ($scope, $http, $timeout, user, userService, analysisService, utilityService, categoryService, $filter) {

    console.log('rr', round(1.005, 2));
